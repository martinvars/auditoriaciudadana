/*
  # Insertar propuestas y habilitar interacción anónima

  1. Cambios
    - Limpia datos existentes
    - Actualiza políticas RLS para permitir votos y comentarios anónimos
    - Inserta las 20 propuestas de ahorro
    - Crea índices para optimizar consultas

  2. Seguridad
    - Permite interacción anónima pero mantiene trazabilidad
    - Habilita RLS para todas las tablas
    - Añade políticas para control de acceso

  3. Datos
    - Inserta 20 propuestas detalladas de ahorro
    - Cada propuesta incluye título, descripción, detalles y ahorro estimado
*/
...
DROP POLICY IF EXISTS "Anyone can change vote" ON votes;
