...
import { ThumbsUp, ThumbsDown, MessageSquare, Share2, Building2, MapPin, Plus, ChevronLeft, ChevronRight, Link, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-8">
        <div className="flex flex-wrap gap-2">
          ...
          >
            <Building2 size={20} />
            <span className="whitespace-nowrap">Nacional</span>
          </button>
          <button
            onClick={() => {
          ...
          >
            <MapPin size={20} />
            <span className="whitespace-nowrap">Autonómico</span>
          </button>
          <button
            onClick={() => {
          ...
          >
            <MapPin size={20} />
            <span className="whitespace-nowrap">Municipal</span>
          </button>
        </div>
        <button
      ...
      {currentProposals.length === 0 ? (
        ...
        currentProposals.map((proposal) => (
          <div key={proposal.id} className="bg-white rounded-xl shadow-lg p-4 md:p-6">
