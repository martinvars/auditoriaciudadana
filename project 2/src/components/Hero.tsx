...
const Hero = () => {
  ...
  const scrollToProposals = () => {
    const proposalsSection = document.querySelector('#proposals');
    if (proposalsSection) {
  ...
  return (
    <>
      <div className="relative h-[400px] md:h-[500px] bg-cover bg-center" style={{
          ...
          <div className="max-w-2xl text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transform hover:scale-105 transition-transform duration-200 w-full sm:w-auto"
              >
                <UserPlus size={20} />
                Hazte Auditor
              </button>
              <button 
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 border-2 border-white text-white rounded-lg hover:bg-white hover:text-gray-900 w-full sm:w-auto"
              >
