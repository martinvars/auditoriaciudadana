  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section id="deuda" className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">Deuda Pública</h2>
          <DebtOverview />
        </section>

        <section id="impuestos" className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">Presión Fiscal</h2>
          <TaxOverview />
        </section>
